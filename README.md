...
<div style="text-align: center;">
  <img src="pigas.png" style="width: 75%; display: block; margin: 0 auto;">
</div>

---

### Overview
**PIGAS** is your **Personal In-Game Adventure Sidekick**, designed to enhance your experience in *World of Warcraft*. 
It allows you to set up a second-hand companion that can assist you in quests, battles, and other adventures.
Check this [YouTube Playlist](https://youtube.com/playlist?list=PLeATIOh7BR3mpmVyYVuS7ALVu5DoykFb8&si=4zl0wYCutd_J7RC_) to see PIGAS in action.
